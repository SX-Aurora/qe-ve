...
SCALAPACK_LIBS="${NLC_LIB} -lscalapack" \
FFT_LIBS="${NLC_LIB} -laslfftw3 -lasl_sequential"            \
DFLAGS="-D__SX6 -D__ARR -D__MPI -D__PARA -D__SCALAPACK -D__FFTW3 -D__NLC -D__NEC -D__ZGEMM3M -D__NON_BLOCKING_SCATTER ${DFTRACEFLAGS}" \
